...
app.delete("/jokes/:id",(req,res)=>{
  ...
  if(index>-1){
    ...
    res.status(404).json({error:`Jokes with id ${id} is not found. No items were deleted`});
  }
});
//8. DELETE All jokes
...
app.delete("/all",(req,res)=>{
  ...
  if(key ===masterKey){
    ...
    res.send(404).json({error:`You have no authentication to perform this operation`});
  }
});
